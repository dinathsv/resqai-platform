...
const styles = StyleSheet.create({
  ...
  badgeWrapper: { flexDirection: 'row', alignItems: 'center', paddingVertical: 5, paddingHorizontal: 12, borderRadius: 20, marginBottom: 10, borderWidth: 1.5 },
  ...
  input: { paddingVertical: 12, paddingHorizontal: 14, fontSize: 15, fontFamily: Fonts.semiBold, borderRadius: 14, borderWidth: 1.5 },
  loginButton: { paddingVertical: 14, borderRadius: 14, alignItems: 'center', marginTop: 8, shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.30, shadowRadius: 12, elevation: 4 },
  ...
  guestButton: { alignItems: 'center', paddingVertical: 14, borderRadius: 14, borderWidth: 1.5 },
